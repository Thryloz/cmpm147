...
let color_num3 = 70
let color_num4 = 255
let color_num_tile_1 = 100
let color_num_tile_2 = 0


let change_speed = 0.0025
let change_speed2 = 0.01
let change_speed3 = 0.05
let change_speed4 = 0.003
let change_speed_tile_1 = 0.01
let change_speed_tile_2 = 0.02

let direction = 1
let direction2 = 1
let direction3 = 1
let direction4 = 1
let direction_tile_1 = 1
let direction_tile_2 = 1
...
function p3_drawTile(i, j) {
  ...
  if (XXH.h32("tile:" + [i, j], worldSeed) % 4 == 0) {
    if (color_num > 150 || color_num < 100){
      direction *= -1;
    }  
    color_num = color_num + (change_speed * direction);
    fill(0, color_num, 255);
  } else if (XXH.h32("tile:" + [i, j], worldSeed) % 3 == 0) {
    if (color_num2 > 200 || color_num2 < 160){
      direction2 *= -1;
    }  
    color_num2 = color_num2 + (change_speed2 * direction2);
    fill(0, color_num2, 255)
  } else if (XXH.h32("tile:" + [i, j], worldSeed) % 7 == 0) {
    if (color_num3 > 100 || color_num3 < 50){
      direction3 *= -1;
    }  
    color_num3 = color_num3 + (change_speed3 * direction3);
    fill(0, color_num3, 255)
  }else {
    if (color_num4 > 255 || color_num4 < 200){
      direction4 *= -1;
    }  
    color_num4 = color_num4 + (change_speed4 * direction4);
    fill(0, color_num4, 255)
  }
