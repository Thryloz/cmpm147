...
function p3_drawTile(i, j) {
  ...
  let xc = constrain(mouseX - width/2, -tw/2 + th/2,  tw/2 - th/2);
  let yc = constrain(mouseY - height/2, -tw/2 + th/2,  tw/2 - th/2);
  let eyeball = circle(xc + random(0, 1), yc + random(0, 1), th);
